...
//
static char *Keypad_keys[16] = { "1", "2", "3", "A", "4", "5", "6", "B", "7",
		"8", "9", "C", "*", "0", "#", "D" };
...
void Keypad4x4_Init(Keypad_WiresTypeDef *KeypadWiringStruct) {
	...
	HAL_GPIO_WritePin(KeypadStruct.OUT0_Port, KeypadStruct.OUT0pin,
			GPIO_PIN_SET);
	HAL_GPIO_WritePin(KeypadStruct.OUT1_Port, KeypadStruct.OUT1pin,
			GPIO_PIN_SET);
	HAL_GPIO_WritePin(KeypadStruct.OUT2_Port, KeypadStruct.OUT2pin,
			GPIO_PIN_SET);
	HAL_GPIO_WritePin(KeypadStruct.OUT3_Port, KeypadStruct.OUT3pin,
			GPIO_PIN_SET);
}
